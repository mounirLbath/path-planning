...
Here are the results I obtained. The parameters were chosen thanks to a grid search.
...
\textbf{Note: } in the final code, in order to avoid to get errors with huge floats, we update \textfff{prob} in such manner:
